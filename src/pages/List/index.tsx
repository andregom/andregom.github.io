...
const List: React.FC = () => {
    ...
    useEffect(() => {
        const filteredDate = pathDependentProps.data.filter(item => {
            ...
            console.log(selectedFrequencies[frequency]);
    ...
    <Container>
        ...
        <Filters>
            <button
                ...
                value="recurrent"
                className={`tag-filter tag-filter-recurrent ${selectedFrequencies['recurrent'] ? ' tag-active' : ''}`}
            ...
            <button
                ...
                value="sporadic"
                className={`tag-filter tag-filter-eventual ${selectedFrequencies['sporadic'] ? ' tag-active' : ''}`}
                onClick={(e) => handleFilterButtonClick(e.currentTarget.value)}
            >
                Eventuais
            </button>
